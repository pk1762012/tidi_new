                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final items = [
                                ...
                                {'title': 'Option Pulse', 'icon': Icons.show_chart, 'color': Colors.cyan, 'onTap': () => Navigator.push(context, MaterialPageRoute(builder: (_) => const OptionPulsePage()))},
                              ];
