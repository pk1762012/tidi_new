...
class _StockScannerSectionState extends State<StockScannerSection>
  ...
  List<UnifiedScan> getUnifiedTechnicalScans() {
    ...
    for (var s in stockData) {
      ...
      final rule180 = s['Technical_Scans']['180_Rule']?.toString().toLowerCase();
      if (rule180 != null) {
      ...
      if (s['Weekly']['Weekly_High_Breakout'] != null && s['Weekly']['Weekly_High_Breakout'] != 'None') {
        weeklyHigh++;
      }
      if (s['Weekly']['Weekly_Low_Breakdown'] != null && s['Weekly']['Weekly_Low_Breakdown'] != 'None') {
        weeklyLow++;
      }
    }
