      ...
      child: loading
        ...
        child: data.isEmpty
          ...
          itemBuilder: (context, index) {
            ...
            final double fiiBuy = parseNum(item["fiiBuy"]);
            final double fiiSell = parseNum(item["fiiSell"]);
            final double diiBuy = parseNum(item["diiBuy"]);
            final double diiSell = parseNum(item["diiSell"]);
            final double fiiNet = fiiBuy - fiiSell;
            final double diiNet = diiBuy - diiSell;
