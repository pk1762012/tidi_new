...
class _AIBotScreenState extends State<AIBotScreen> with TickerProviderStateMixin {
  ...
  final List<String> _suggestedQuestions = [
    ...
    "Buy, sell or hold HDFC Bank?",
    "Best SIP stocks for next 5 years",
    "Technical analysis of INFY",
    "Support and resistance for ITC",
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      final response = await apiService.aiChat(history, text);
  ...
  void initState() {
    ...
    _shuffledQuestions = List<String>.from(_suggestedQuestions)..shuffle();
  }
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 10,
          runSpacing: 10,
          children: _shuffledQuestions.take(4).map((q) {
