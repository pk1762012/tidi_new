...
class StockChatScreen extends StatefulWidget {
  ...
  const StockChatScreen({super.key, required this.symbol});

  @override
  State<StockChatScreen> createState() => _StockChatScreenState();
}

class _StockChatScreenState extends State<StockChatScreen> with TickerProviderStateMixin {
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      final response = await apiService.stockChat(widget.symbol+'.NS', history, text);
